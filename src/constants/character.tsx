...
export const CharGenData: CharacterGeneration = {
	...
	specialisation: [
		...
		},
		{
			...
			bonus: "+2 MAG, +1 MAG or LCK, +2 LCK",
		},
		{
			roll: 5,
			name: "Reinforcement",
		...
		},
		{
			...
			bonus: "+1 STR, +1 AGI, +1 VIT or LCK",
		},
		{
			roll: 19,
			name: "Metal",
		...
		},
		{
			...
			bonus: "+2 to one stat, +1 to one other stat",
		},
	],
	weapon: [
		{
		...
		support: [
			{
				...
				description:
					"Encounter an interdimensional traveler who helps you out.",
				bonus: "",
			},
			{
				roll: 2,
